...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'zig-out/www/example_raylib.data';
      var REMOTE_PACKAGE_BASE = 'example_raylib.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_zig-out/www/example_raylib.data');

      };
      Module['addRunDependency']('datafile_zig-out/www/example_raylib.data');
   ...
   loadPackage({"files": [{"filename": "/monofonto.otf", "start": 0, "end": 23008}], "remote_package_size": 23008, "package_uuid": "7fccc890-29e2-420c-a4a5-8d69a183c750"});
...
var wasmBinaryFile;
  wasmBinaryFile = 'example_raylib.wasm';
